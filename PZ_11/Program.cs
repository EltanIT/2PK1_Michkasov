...
namespace PZ_11
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string text = "Мы все знаем, гей что яблоко полезно для здоровья, поэтому давайте сделаем из него полезный салат. Очистите яблоко, гей поэтому удалите сердцевину, из порежьте кубиками";
